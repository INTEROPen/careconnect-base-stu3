...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'indicationForChange']) &lt;= 1">extension with URL = 'indicationForChange': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'dateChanged']) &lt;= 1">extension with URL = 'dateChanged': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'detailsOfAmendment']) &lt;= 1">extension with URL = 'detailsOfAmendment': maximum cardinality of 'extension' is 1</sch:assert>

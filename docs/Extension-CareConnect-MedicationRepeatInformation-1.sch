...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'numberOfRepeatPrescriptionsAllowed']) &lt;= 1">extension with URL = 'numberOfRepeatPrescriptionsAllowed': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'numberOfRepeatPrescriptionsIssued']) &lt;= 1">extension with URL = 'numberOfRepeatPrescriptionsIssued': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'authorisationExpiryDate']) &lt;= 1">extension with URL = 'authorisationExpiryDate': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension/f:extension">
      ...
      <sch:assert test="count(f:valueUnsignedInt) &lt;= 1">valueUnsignedInt: maximum cardinality of 'valueUnsignedInt' is 1</sch:assert>
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:url) &lt;= 1">url: maximum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:valueUnsignedInt) &lt;= 1">valueUnsignedInt: maximum cardinality of 'valueUnsignedInt' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>Extension.extension.valueUnsignedInt</sch:title>
    <sch:rule context="f:Extension/f:extension/f:valueUnsignedInt">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
    </sch:rule>
  </sch:pattern>
